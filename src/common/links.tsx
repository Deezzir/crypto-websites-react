...
const iconClass = "w-10 h-10 md:w-12 md:h-12 fill-white";
...
export const Links = (props: any) => {
  return (
    <div
      className={
        "w-full z-50 flex justify-center md:justify-end items-center md:items-end gap-4 flex-row flex-wrap max-w-screen-2xl ms-auto" +
        props.customClass
      }
    >
      <Checker val={TWITTER}>
